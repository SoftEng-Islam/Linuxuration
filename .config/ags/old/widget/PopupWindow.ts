...
export const Padding = (name: string, { css = "", hexpand = true, vexpand = true }: EventBoxProps = {}) =>
	Widget.EventBox({
		hexpand,
		vexpand,
		can_focus: false,
...
export default ({ name, child, layout = "center", transition, exclusivity = "ignore", ...props }: PopupWindowProps) =>
