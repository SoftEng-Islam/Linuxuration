	...
	return Widget.Box(
		...
		Widget.Button(
			...
			Widget.Box(
				...
				Widget.Box([description as ReturnType<typeof Widget.Label>, subpkg as ReturnType<typeof Widget.Label>])
			)
		)
	);
}
...
export function Spinner() {
	...
	return Widget.Revealer({
		...
		child: icon,
		reveal_child: Utils.merge([nix.bind("ready"), iconVisible.bind()], (ready, show) => !ready || show)
	});
}
