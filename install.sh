...
echo "Install base-devel linux-headers git.........."
if sudo pacman -S --noconfirm --needed base-devel linux-headers git; then
  echo "base-devel, linux-headers and git has been installed successfully."
else
...
setup_yay() {
  if command -v yay &>/dev/null; then
    ...
    cd /tmp/yay || echo "ERROR: cd /tmp/yay"
